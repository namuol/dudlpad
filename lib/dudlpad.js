(function() {
  ...
  __clearCallbacks = {};
  canHaveCallback = function(inner, retVal) {
    ...
    return func = function() {
      var aft, args, bef, beforeResults, res, _i, _j, _len, _len2;
      ...
      for (_j = 0, _len2 = after.length; _j < _len2; _j++) {
        aft = after[_j];
        aft.apply(pad, args);
      }
      return res;
  ...
  DUDLPAD.create = function(container, width, height) {
    var canvas, clearCanvas, context, drawLines, drawing, hist, lineWidth, pad, resetAll, resetCanvas, strokeStyle;
    if (!(container != null)) {
